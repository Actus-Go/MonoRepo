            ...
            <div className={`   ${"relative   "}`}>
              {post.images.length > 0 && (
                ...
                className=""
                  ...
                  dragEnabled={post.images.length <= 1 ? false : true}
                  touchEnabled={post.images.length <= 1 ? false : true}
                        ...
                        <Link
                          ...
                          <span className='w-full capitalize z-20 flex flex-col'>
                            <span className='text-left w-full text-[#efff55] gap-0 flex px-1'>
                              {`${post.user.first_name} ${post.user.last_name}`.slice(0, 10)} {premium === true ? (
                                <span className={`${
                                  `${post.user.first_name} ${post.user.last_name}`.length > 10 ? 'text-sm' : ''
                                }`}>
                                </span>
                              ) : ""}
