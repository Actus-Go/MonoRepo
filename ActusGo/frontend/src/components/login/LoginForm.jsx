...
export default function LoginForm({ setVisible }) {
  ...
  c13.74,0,25.69,10.57,25.69,34.17C1216.93,345.47,1204.98,356.03,1191.24,356.03z" />
                ...
                <Form className="space-y-6">
                  ...
                  <div>
                    <div className="flex items-center justify-between">
                      ...
                      <Link to="/reset" className="text-sm font-semibold text-indigo-600 hover:text-indigo-500">
      ...
      <div className="hidden lg:flex w-1/2 bg-gray-50 flex-col items-center justify-center px-6 py-12 lg:px-8">
