...
export default function NotificationBar({
  ...
  return (
    <div className={`h-screen fixed z-50 top-0 right-0 overflow-x-hidden overflow-y-auto transition-all bg-black text-white w-full max-w-sm mx-auto rounded-lg shadow-lg ${isOpen ? "translate-x-0" : "translate-x-full"}`}>
